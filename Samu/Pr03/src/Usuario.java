...
public class Usuario {
    ...
    public Usuario(String n, String p, Rol r) {
        ...
        BD miBD = new BD(BD_SERVER, BD_NAME);
        miBD.Insert(String.format("Insert into tUsuario(nombre, password, rolName) values ('%s1', '%s2', '%s3');",
                n, p, r.getRolName()));
        this.nombre = n;
        this.password = p;
        this.rol = r;
    ...
    public void setNombre(String value) {
        ...
        BD miBD = new BD(BD_SERVER, BD_NAME);
        miBD.Update(String.format("update tUsuario set nombre = '%s1' where nombre = '%s2';", value, this.nombre));
        this.nombre = value;
    ...
    public void borraUsuario() {
        // Actualiza el atributo en memoria y en la base de datos
        BD miBD = new BD(BD_SERVER, BD_NAME);
        miBD.Delete(String.format("delete from tUsuario where nombre = '%s1';", this.nombre));
    }
    ...
    public void setPassword(String value) {
        // Actualiza el atributo en memoria y en la base de datos
        BD miBD = new BD(BD_SERVER, BD_NAME);
        miBD.Update(String.format("update tUsuario set password = '%s1' where nombre = '%s2';", value, this.nombre));
        this.password = value;
    ...
    public void ModiRol(Usuario u, Rol r) {
        ...
        if(this.rol.getAdmin()){
            BD miBD = new BD(BD_SERVER, BD_NAME);
            miBD.Update(String.format("update tUsuario set rolName = '%s1' where nombre = '%s2';", r.getRolName(),
                    u.nombre));
            u.rol = r;
        }
