...
public class Rol 
{
    ...
    {
    	throw new Error("Un p3.Rol no puede concederse permisos de administraci�n a s� mismo.");
    }
    public void setAdmin(Rol other, boolean value)
    {
    	if (!admin) throw new Error("p3.Rol sin permiso para establecer administradores.");
